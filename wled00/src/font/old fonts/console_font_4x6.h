...
static const unsigned char console_font_4x6[] = {
    ...
    0x00,
    0x00,
    0x00,  // Header: Magic, H, W, Spacing, Flags, First, Last, Reserved, UnicodeOffset
    ...
    0x00,
    0x00,
    0x00, /* code=32, hex=0x20, ascii=" " */
    0x22,
    0x20,
    0x20, /* code=33, hex=0x21, ascii="!" */
    0x55,
    0x00,
    0x00, /* code=34, hex=0x22, ascii=""" */
    0x57,
    0x57,
    0x50, /* code=35, hex=0x23, ascii="#" */
    0x23,
    0x63,
    0x62, /* code=36, hex=0x24, ascii="$" */
    0x41,
    0x24,
    0x10, /* code=37, hex=0x25, ascii="%" */
    0x25,
    0x35,
    0x70, /* code=38, hex=0x26, ascii="&" */
    0x64,
    0x00,
    0x00, /* code=39, hex=0x27, ascii="'" */
    0x24,
    0x44,
    0x20, /* code=40, hex=0x28, ascii="(" */
    0x42,
    0x22,
    0x40, /* code=41, hex=0x29, ascii=")" */
    0x52,
    0x72,
    0x50, /* code=42, hex=0x2A, ascii="*" */
    0x02,
    0x72,
    0x00, /* code=43, hex=0x2B, ascii="+" */
    0x00,
    0x00,
    0x64, /* code=44, hex=0x2C, ascii="," */
    0x00,
    0x70,
    0x00, /* code=45, hex=0x2D, ascii="-" */
    0x00,
    0x00,
    0x20, /* code=46, hex=0x2E, ascii="." */
    0x11,
    0x24,
    0x40, /* code=47, hex=0x2F, ascii="/" */
    0x35,
    0x55,
    0x60, /* code=48, hex=0x30, ascii="0" */
    0x26,
    0x22,
    0x70, /* code=49, hex=0x31, ascii="1" */
    0x61,
    0x24,
    0x70, /* code=50, hex=0x32, ascii="2" */
    0x61,
    0x21,
    0x60, /* code=51, hex=0x33, ascii="3" */
    0x15,
    0x71,
    0x10, /* code=52, hex=0x34, ascii="4" */
    0x74,
    0x61,
    0x60, /* code=53, hex=0x35, ascii="5" */
    0x24,
    0x65,
    0x20, /* code=54, hex=0x36, ascii="6" */
    0x71,
    0x32,
    0x20, /* code=55, hex=0x37, ascii="7" */
    0x25,
    0x25,
    0x20, /* code=56, hex=0x38, ascii="8" */
    0x25,
    0x31,
    0x20, /* code=57, hex=0x39, ascii="9" */
    0x00,
    0x20,
    0x20, /* code=58, hex=0x3A, ascii=":" */
    0x00,
    0x20,
    0x64, /* code=59, hex=0x3B, ascii=";" */
    0x12,
    0x42,
    0x10, /* code=60, hex=0x3C, ascii="<" */
    0x00,
    0x70,
    0x70, /* code=61, hex=0x3D, ascii="=" */
    0x42,
    0x12,
    0x40, /* code=62, hex=0x3E, ascii=">" */
    0x61,
    0x20,
    0x20, /* code=63, hex=0x3F, ascii="?" */
    0x75,
    0x54,
    0x70, /* code=64, hex=0x40, ascii="@" */
    0x25,
    0x75,
    0x50, /* code=65, hex=0x41, ascii="A" */
    0x65,
    0x65,
    0x60, /* code=66, hex=0x42, ascii="B" */
    0x34,
    0x44,
    0x30, /* code=67, hex=0x43, ascii="C" */
    0x65,
    0x55,
    0x60, /* code=68, hex=0x44, ascii="D" */
    0x74,
    0x64,
    0x70, /* code=69, hex=0x45, ascii="E" */
    0x74,
    0x64,
    0x40, /* code=70, hex=0x46, ascii="F" */
    0x34,
    0x55,
    0x30, /* code=71, hex=0x47, ascii="G" */
    0x55,
    0x75,
    0x50, /* code=72, hex=0x48, ascii="H" */
    0x72,
    0x22,
    0x70, /* code=73, hex=0x49, ascii="I" */
    0x11,
    0x15,
    0x20, /* code=74, hex=0x4A, ascii="J" */
    0x55,
    0x65,
    0x50, /* code=75, hex=0x4B, ascii="K" */
    0x44,
    0x44,
    0x70, /* code=76, hex=0x4C, ascii="L" */
    0x57,
    0x75,
    0x50, /* code=77, hex=0x4D, ascii="M" */
    0x57,
    0x55,
    0x50, /* code=78, hex=0x4E, ascii="N" */
    0x25,
    0x55,
    0x20, /* code=79, hex=0x4F, ascii="O" */
    0x65,
    0x64,
    0x40, /* code=80, hex=0x50, ascii="P" */
    0x25,
    0x57,
    0x30, /* code=81, hex=0x51, ascii="Q" */
    0x65,
    0x65,
    0x50, /* code=82, hex=0x52, ascii="R" */
    0x34,
    0x71,
    0x60, /* code=83, hex=0x53, ascii="S" */
    0x72,
    0x22,
    0x20, /* code=84, hex=0x54, ascii="T" */
    0x55,
    0x55,
    0x70, /* code=85, hex=0x55, ascii="U" */
    0x55,
    0x55,
    0x20, /* code=86, hex=0x56, ascii="V" */
    0x55,
    0x77,
    0x50, /* code=87, hex=0x57, ascii="W" */
    0x55,
    0x25,
    0x50, /* code=88, hex=0x58, ascii="X" */
    0x55,
    0x22,
    0x20, /* code=89, hex=0x59, ascii="Y" */
    0x71,
    0x24,
    0x70, /* code=90, hex=0x5A, ascii="Z" */
    0x64,
    0x44,
    0x60, /* code=91, hex=0x5B, ascii="[" */
    0x44,
    0x21,
    0x10, /* code=92, hex=0x5C, ascii="\" */
    0x62,
    0x22,
    0x60, /* code=93, hex=0x5D, ascii="]" */
    0x25,
    0x00,
    0x00, /* code=94, hex=0x5E, ascii="^" */
    0x00,
    0x00,
    0x0F, /* code=95, hex=0x5F, ascii="_" */
    0x62,
    0x00,
    0x00, /* code=96, hex=0x60, ascii="`" */
    0x00,
    0x35,
    0x70, /* code=97, hex=0x61, ascii="a" */
    0x44,
    0x65,
    0x60, /* code=98, hex=0x62, ascii="b" */
    0x00,
    0x34,
    0x30, /* code=99, hex=0x63, ascii="c" */
    0x11,
    0x35,
    0x30, /* code=100, hex=0x64, ascii="d" */
    0x00,
    0x76,
    0x30, /* code=101, hex=0x65, ascii="e" */
    0x12,
    0x72,
    0x20, /* code=102, hex=0x66, ascii="f" */
    0x00,
    0x75,
    0x17, /* code=103, hex=0x67, ascii="g" */
    0x44,
    0x65,
    0x50, /* code=104, hex=0x68, ascii="h" */
    0x20,
    0x22,
    0x20, /* code=105, hex=0x69, ascii="i" */
    0x20,
    0x22,
    0x26, /* code=106, hex=0x6A, ascii="j" */
    0x44,
    0x56,
    0x50, /* code=107, hex=0x6B, ascii="k" */
    0x22,
    0x22,
    0x20, /* code=108, hex=0x6C, ascii="l" */
    0x00,
    0x77,
    0x50, /* code=109, hex=0x6D, ascii="m" */
    0x00,
    0x65,
    0x50, /* code=110, hex=0x6E, ascii="n" */
    0x00,
    0x25,
    0x20, /* code=111, hex=0x6F, ascii="o" */
    0x00,
    0x65,
    0x64, /* code=112, hex=0x70, ascii="p" */
    0x00,
    0x35,
    0x31, /* code=113, hex=0x71, ascii="q" */
    0x00,
    0x64,
    0x40, /* code=114, hex=0x72, ascii="r" */
    0x00,
    0x32,
    0x60, /* code=115, hex=0x73, ascii="s" */
    0x02,
    0x72,
    0x30, /* code=116, hex=0x74, ascii="t" */
    0x00,
    0x55,
    0x70, /* code=117, hex=0x75, ascii="u" */
    0x00,
    0x55,
    0x20, /* code=118, hex=0x76, ascii="v" */
    0x00,
    0x57,
    0x70, /* code=119, hex=0x77, ascii="w" */
    0x00,
    0x52,
    0x50, /* code=120, hex=0x78, ascii="x" */
    0x00,
    0x55,
    0x24, /* code=121, hex=0x79, ascii="y" */
    0x00,
    0x62,
    0x30, /* code=122, hex=0x7A, ascii="z" */
    0x32,
    0x62,
    0x30, /* code=123, hex=0x7B, ascii="{" */
    0x22,
    0x22,
    0x20, /* code=124, hex=0x7C, ascii="|" */
    0x62,
    0x32,
    0x60, /* code=125, hex=0x7D, ascii="}" */
    0x5A,
    0x00,
    0x00, /* code=126, hex=0x7E, ascii="~" */
