...
static const unsigned char console_font_5x8[] = {
    ...
    0xF5,
    0x7D,
    0x40, /* code=35, hex=0x23, ascii="#" */
    0x00,
    0x08,
    0x64,
    0x19,
    0x84, /* code=36, hex=0x24, ascii="$" */
    0x02,
    0x2A,
    0xA3,
    0x36,
    0x40, /* code=37, hex=0x25, ascii="%" */
    0x00,
    0x0C,
    0x86,
    0xC9,
    0xA0, /* code=38, hex=0x26, ascii="&" */
    0x01,
    0x08,
    0x00,
    0x00,
    ...
    0x84,
    0x20,
    0x80, /* code=40, hex=0x28, ascii="(" */
    0x00,
    0x10,
    0x42,
    0x11,
    0x00, /* code=41, hex=0x29, ascii=")" */
    0x00,
    0x14,
    0x47,
    0x11,
    0x40, /* code=42, hex=0x2A, ascii="*" */
    0x00,
    0x00,
    0x47,
    0x10,
    ...
    0x00,
    0x00,
    0x80, /* code=46, hex=0x2E, ascii="." */
    0x00,
    0x04,
    0x42,
    0x21,
    0x00, /* code=47, hex=0x2F, ascii="/" */
    0x00,
    0x19,
    0x29,
    0x49,
    0x80, /* code=48, hex=0x30, ascii="0" */
    0x00,
    0x08,
    0xC2,
    0x10,
    0x80, /* code=49, hex=0x31, ascii="1" */
    0x00,
    0x19,
    0x22,
    0x23,
    0xC0, /* code=50, hex=0x32, ascii="2" */
    0x00,
    0x38,
    0x26,
    0x0B,
    0x80, /* code=51, hex=0x33, ascii="3" */
    0x00,
    0x04,
    0x65,
    0x78,
    0x40, /* code=52, hex=0x34, ascii="4" */
    0x00,
    0x3D,
    0x0E,
    0x0B,
    0x80, /* code=53, hex=0x35, ascii="5" */
    0x00,
    0x19,
    0x0E,
    0x49,
    0x80, /* code=54, hex=0x36, ascii="6" */
    0x00,
    0x3C,
    0x22,
    0x21,
    0x00, /* code=55, hex=0x37, ascii="7" */
    0x00,
    0x19,
    0x26,
    0x49,
    0x80, /* code=56, hex=0x38, ascii="8" */
    0x00,
    0x19,
    0x27,
    0x09,
    0x80, /* code=57, hex=0x39, ascii="9" */
    0x00,
    0x00,
    0x02,
    0x00,
    0x80, /* code=58, hex=0x3A, ascii=":" */
    0x00,
    0x00,
    0x02,
    0x00,
    0x88, /* code=59, hex=0x3B, ascii=";" */
    0x00,
    0x04,
    0x44,
    0x10,
    0x40, /* code=60, hex=0x3C, ascii="<" */
    0x00,
    0x00,
    0xE0,
    0x38,
    0x00, /* code=61, hex=0x3D, ascii="=" */
    0x00,
    0x10,
    0x41,
    0x11,
    0x00, /* code=62, hex=0x3E, ascii=">" */
    0x00,
    0x18,
    0x26,
    0x01,
    0x00, /* code=63, hex=0x3F, ascii="?" */
    0x00,
    0x1D,
    0x1B,
    0x41,
    0xC0, /* code=64, hex=0x40, ascii="@" */
    0x00,
    0x19,
    0x2F,
    0x4A,
    0x40, /* code=65, hex=0x41, ascii="A" */
    0x00,
    0x39,
    0x2E,
    0x4B,
    0x80, /* code=66, hex=0x42, ascii="B" */
    0x00,
    0x1D,
    0x08,
    0x41,
    0xC0, /* code=67, hex=0x43, ascii="C" */
    0x00,
    0x39,
    0x29,
    0x4B,
    0x80, /* code=68, hex=0x44, ascii="D" */
    0x00,
    0x3D,
    0x0E,
    0x43,
    0xC0, /* code=69, hex=0x45, ascii="E" */
    0x00,
    0x3D,
    0x0E,
    0x42,
    0x00, /* code=70, hex=0x46, ascii="F" */
    0x00,
    0x19,
    0x28,
    0x49,
    0xC0, /* code=71, hex=0x47, ascii="G" */
    0x00,
    0x25,
    0x2F,
    0x4A,
    0x40, /* code=72, hex=0x48, ascii="H" */
    0x00,
    0x1C,
    0x42,
    0x11,
    0xC0, /* code=73, hex=0x49, ascii="I" */
    0x00,
    0x04,
    0x29,
    0x49,
    0x80, /* code=74, hex=0x4A, ascii="J" */
    0x00,
    0x25,
    0x4C,
    0x52,
    0x40, /* code=75, hex=0x4B, ascii="K" */
    0x00,
    0x21,
    0x08,
    0x43,
    0xC0, /* code=76, hex=0x4C, ascii="L" */
    0x00,
    0x25,
    0xE9,
    0x4A,
    0x40, /* code=77, hex=0x4D, ascii="M" */
    0x00,
    0x25,
    0xAB,
    0x4A,
    0x40, /* code=78, hex=0x4E, ascii="N" */
    0x00,
    0x19,
    0x29,
    0x49,
    0x80, /* code=79, hex=0x4F, ascii="O" */
    0x00,
    0x39,
    0x2E,
    0x42,
    0x00, /* code=80, hex=0x50, ascii="P" */
    0x00,
    0x19,
    0x29,
    0x49,
    0x82, /* code=81, hex=0x51, ascii="Q" */
    0x00,
    0x39,
    0x2E,
    0x4A,
    0x40, /* code=82, hex=0x52, ascii="R" */
    0x00,
    0x1D,
    0x06,
    0x0B,
    0x80, /* code=83, hex=0x53, ascii="S" */
    0x00,
    0x3E,
    0x42,
    0x10,
    0x80, /* code=84, hex=0x54, ascii="T" */
    0x00,
    0x25,
    0x29,
    0x49,
    0x80, /* code=85, hex=0x55, ascii="U" */
    0x00,
    0x25,
    0x29,
    0x31,
    0x80, /* code=86, hex=0x56, ascii="V" */
    0x00,
    0x23,
    0x5A,
    0xA9,
    0x40, /* code=87, hex=0x57, ascii="W" */
    0x00,
    0x25,
    0x26,
    0x2A,
    0x40, /* code=88, hex=0x58, ascii="X" */
    0x00,
    0x14,
    0xA5,
    0x10,
    0x80, /* code=89, hex=0x59, ascii="Y" */
    0x00,
    0x3C,
    0x44,
    0x43,
    0xC0, /* code=90, hex=0x5A, ascii="Z" */
    0x00,
    0x18,
    0x84,
    0x21,
    0x80, /* code=91, hex=0x5B, ascii="[" */
    0x00,
    0x10,
    0x82,
    0x10,
    0x40, /* code=92, hex=0x5C, ascii="\" */
    0x00,
    0x18,
    0x42,
    0x11,
    0x80, /* code=93, hex=0x5D, ascii="]" */
    0x00,
    0x08,
    0xA0,
    0x00,
    ...
    0xC1,
    0x39,
    0x40, /* code=97, hex=0x61, ascii="a" */
    0x04,
    0x21,
    0xC9,
    0x4B,
    0x80, /* code=98, hex=0x62, ascii="b" */
    0x00,
    0x00,
    0x64,
    0x20,
    0xC0, /* code=99, hex=0x63, ascii="c" */
    0x00,
    0x04,
    0xE9,
    0x49,
    0xC0, /* code=100, hex=0x64, ascii="d" */
    0x00,
    0x00,
    0xCF,
    0x41,
    0xC0, /* code=101, hex=0x65, ascii="e" */
    0x00,
    0x0C,
    0x8E,
    0x21,
    0x00, /* code=102, hex=0x66, ascii="f" */
    0x00,
    0x00,
    0xE9,
    0x38,
    0x4C, /* code=103, hex=0x67, ascii="g" */
    0x00,
    0x21,
    0xC9,
    0x4A,
    0x40, /* code=104, hex=0x68, ascii="h" */
    0x01,
    0x00,
    0xC2,
    0x11,
    0xC0, /* code=105, hex=0x69, ascii="i" */
    0x00,
    0x80,
    0x21,
    0x08,
    0x4C, /* code=106, hex=0x6A, ascii="j" */
    0x00,
    0x21,
    0x4C,
    0x52,
    0x40, /* code=107, hex=0x6B, ascii="k" */
    0x03,
    0x08,
    0x42,
    0x11,
    0xC0, /* code=108, hex=0x6C, ascii="l" */
    0x00,
    0x01,
    0x2F,
    0x4A,
    0x40, /* code=109, hex=0x6D, ascii="m" */
    0x00,
    0x01,
    0xC9,
    0x4A,
    0x40, /* code=110, hex=0x6E, ascii="n" */
    0x00,
    0x00,
    0xC9,
    0x49,
    0x80, /* code=111, hex=0x6F, ascii="o" */
    0x00,
    0x01,
    0xC9,
    0x4B,
    0x90, /* code=112, hex=0x70, ascii="p" */
    0x00,
    0x00,
    0xE9,
    0x49,
    0xC2, /* code=113, hex=0x71, ascii="q" */
    0x00,
    0x00,
    0xA6,
    0x21,
    0x00, /* code=114, hex=0x72, ascii="r" */
    0x00,
    0x00,
    0xEC,
    0x1B,
    0x80, /* code=115, hex=0x73, ascii="s" */
    0x00,
    0x11,
    0xE4,
    0x20,
    0xC0, /* code=116, hex=0x74, ascii="t" */
    0x00,
    0x01,
    0x29,
    0x49,
    0xC0, /* code=117, hex=0x75, ascii="u" */
    0x00,
    0x01,
    0x29,
    0x31,
    0x80, /* code=118, hex=0x76, ascii="v" */
    0x00,
    0x01,
    0x29,
    0x7A,
    0x40, /* code=119, hex=0x77, ascii="w" */
    0x00,
    0x01,
    0x26,
    0x32,
    0x40, /* code=120, hex=0x78, ascii="x" */
    0x00,
    0x01,
    0x29,
    0x38,
    0x4C, /* code=121, hex=0x79, ascii="y" */
    0x00,
    0x01,
    0xE2,
    0x23,
    0xC0, /* code=122, hex=0x7A, ascii="z" */
    0x00,
    0x88,
    0x84,
    0x10,
    0x40, /* code=123, hex=0x7B, ascii="{" */
    0x01,
    0x08,
    0x42,
    0x10,
    0x80, /* code=124, hex=0x7C, ascii="|" */
    0x02,
    0x08,
    0x21,
    0x11,
    0x00, /* code=125, hex=0x7D, ascii="}" */
    0x00,
    0x00,
    0xAA,
    0x00,
