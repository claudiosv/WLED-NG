...
const TProgmemRGBPalette16 CloudColors_p = {CRGB::Blue,      CRGB::DarkBlue, CRGB::DarkBlue,  CRGB::DarkBlue,
...
// Lava color palette
const TProgmemRGBPalette16 LavaColors_p = {CRGB::Black,   CRGB::Maroon,  CRGB::Black,  CRGB::Maroon,
...
const uint8_t ib_jul01_gp[] = {0, 226, 6, 12, 94, 26, 96, 78, 132, 130, 189, 94, 255, 177, 3, 9};

// Gradient palette "es_vintage_57_gp", originally from
// http://seaviewsensing.com/pub/cpt-city/es/vintage/es_vintage_57.c3g
const uint8_t es_vintage_57_gp[] = {0, 29, 8, 3, 53, 76, 1, 0, 104, 142, 96, 28, 153, 211, 191, 61, 255, 117, 129, 42};

// Gradient palette "es_vintage_01_gp", originally from
// http://seaviewsensing.com/pub/cpt-city/es/vintage/es_vintage_01.c3g
const uint8_t es_vintage_01_gp[] = {0,   41,  18, 24, 51,  73, 0, 22, 76,  165, 170, 38, 101, 255, 189, 80,
...
const uint8_t es_rivendell_15_gp[] = {0,   24, 69,  44,  101, 73,  105, 70,  165, 129,
                                      140, 97, 242, 200, 204, 166, 255, 200, 204, 166};

// Gradient palette "rgi_15_gp", originally from
// http://seaviewsensing.com/pub/cpt-city/ds/rgi/rgi_15.c3g
const uint8_t rgi_15_gp[] = {0,  41,  14,  99,  31, 128, 24,  74,  63, 227, 34,  50,  95, 132, 31,  76, 127, 47,
...
const uint8_t retro2_16_gp[] = {0, 222, 191, 8, 255, 117, 52, 1};

// Gradient palette "Analogous_1_gp", originally from
// http://seaviewsensing.com/pub/cpt-city/nd/red/Analogous_1.c3g
const uint8_t Analogous_1_gp[] = {0, 38, 0, 255, 63, 86, 0, 255, 127, 139, 0, 255, 191, 196, 0, 117, 255, 255, 0, 0};
...
const uint8_t es_ocean_breeze_036_gp[] = {0, 16, 48, 51, 89, 27, 166, 175, 153, 197, 233, 255, 255, 0, 145, 152};

// Gradient palette "departure_gp", originally from
// http://seaviewsensing.com/pub/cpt-city/mjf/departure.c3g
const uint8_t departure_gp[] = {0,   53,  34,  0,   42,  86,  51,  0,   63,  147, 108, 49,  84,  212, 166, 108,
...
const uint8_t es_landscape_64_gp[] = {0,   0,   0,   0,   37,  31,  89,  19,  76,  72,  178, 43,
...
const uint8_t Tertiary_01_gp[] = {0,   0, 25,  255, 63,  38, 140, 117, 127, 86,
                                  255, 0, 191, 167, 140, 19, 255, 255, 25,  41};

// Gradient palette "lava_gp", originally from
// http://seaviewsensing.com/pub/cpt-city/neota/elem/lava.c3g
const uint8_t lava_gp[] = {0,   0,   0,   0,   46,  77,  0,   0,   96,  177, 0,   0,   108, 196, 38,  9,   119, 215,
...
const uint8_t fierce_ice_gp[] = {0,   0,   0,   0,  59,  0,   51,  117, 119, 0,   102, 255, 149, 38,
...
const uint8_t Colorfull_gp[] = {0,   61,  155, 44,  25,  95,  174, 77,  60,  132, 193, 113, 93,  154, 166,
...
const uint8_t Pink_Purple_gp[] = {0,   79,  32,  109, 25,  90,  40,  117, 51,  102, 48,  124, 76,  141, 135,
...
const uint8_t Sunset_Real_gp[] = {0,  181, 0,   0,   22, 218, 85,  0,  51, 255, 170, 0, 85, 211,
...
const uint8_t Sunset_Yellow_gp[] = {0,   61,  135, 184, 36,  129, 188, 169, 87,  203, 241, 155, 100, 228, 237,
...
const uint8_t Beech_gp[] = {0,   255, 254, 236, 12,  255, 254, 236, 22,  255, 254, 236, 26,  223, 224,
...
const uint8_t Another_Sunset_gp[] = {0,  175, 121, 62, 29,  128, 103, 60,  68,  84,  84,  58,  68,  248, 184, 55,
...
const uint8_t es_autumn_19_gp[] = {0,   90,  14,  5,   51,  139, 41,  13,  84,  180, 70,  17,  104,
...
const uint8_t BlacK_Blue_Magenta_White_gp[] = {0, 0,   0,   0,   42, 0,   0,   117, 84,  0,   0,   255, 127, 113,
...
const uint8_t BlacK_Magenta_Red_gp[] = {0, 0,   0,   0,   63, 113, 0,   117, 127, 255,
                                        0, 255, 191, 255, 0,  117, 255, 255, 0,   0};

// Gradient palette "BlacK_Red_Magenta_Yellow_gp", originally from
// http://seaviewsensing.com/pub/cpt-city/nd/basic/BlacK_Red_Magenta_Yellow.c3g
const uint8_t BlacK_Red_Magenta_Yellow_gp[] = {0, 0,   0,   0,   42, 113, 0,   0,   84,  255, 0,   0,   127, 255,
...
const uint8_t Blue_Cyan_Yellow_gp[] = {0,   0,   0,   255, 63,  0,   128, 255, 127, 0,
                                       255, 255, 191, 113, 255, 117, 255, 255, 255, 0};

// Custom palette by Aircoookie
const byte Orange_Teal_gp[] = {0, 0, 150, 92, 55, 0, 150, 92, 200, 255, 72, 0, 255, 255, 72, 0};

// Custom palette by Aircoookie
const byte Tiamat_gp[] = {0,   1,   2,   14,   // gc
...
// Custom palette by Aircoookie
const byte April_Night_gp[] = {0,   1, 5, 45,                                       // deep blue
...
const byte Orangery_gp[] = {0,   255, 95,  23,  30, 255, 82,  0,   60, 223, 13,  8,   90, 144, 44,  2,   120, 255,
...
const byte C9_gp[] = {0,   184, 4,  0,                    // red
                      60,  184, 4,  0, 65,  144, 44, 2,   // amber
                      125, 144, 44, 2, 130, 4,   96, 2,   // green
                      190, 4,   96, 2, 195, 7,   7,  88,  // blue
                      255, 7,   7,  88};

const byte Sakura_gp[] = {0, 196, 19, 10, 65, 255, 69, 45, 130, 223, 45, 72, 195, 255, 82, 103, 255, 223, 13, 17};

const byte Aurora_gp[] = {0,   1, 5,   45,                                  // deep blue
                          64,  0, 200, 23, 128, 0, 255, 0,                  // green
                          170, 0, 243, 45, 200, 0, 135, 7, 255, 1, 5, 45};  // deep blue

const byte Atlantica_gp[] = {0,   0,  28,  112,                   // #001C70
                             50,  32, 96,  255,                   // #2060FF
                             100, 0,  243, 45,  150, 12, 95, 82,  // #0C5F52
                             200, 25, 190, 95,                    // #19BE5F
                             255, 40, 170, 80};                   // #28AA50

const byte C9_2_gp[] = {0,   6,   126, 2,                       // green
...
const byte C9_new_gp[] = {0,   255, 5,   0,                       // red
...
const uint8_t temperature_gp[] = {0,   20,  92,  171, 14,  15,  111, 186, 28,  6,   142, 211, 42,  2,   161,
...
const uint8_t candy_gp[] = {0, 243, 242, 23, 15, 242, 168, 38, 142, 111, 21, 151, 198, 74, 22, 150, 255, 0, 0, 117};

// Gradient palette "bhw1_05_gp", originally from
// http://seaviewsensing.com/pub/cpt-city/bhw/bhw1/bhw1_05.c3g
const uint8_t toxy_reaf_gp[] = {0, 2, 239, 126, 255, 145, 35, 217};

// Gradient palette "bhw1_06_gp", originally from
// http://seaviewsensing.com/pub/cpt-city/bhw/bhw1/bhw1_06.c3g
const uint8_t fairy_reaf_gp[] = {0, 220, 19, 187, 160, 12, 225, 219, 219, 203, 242, 223, 255, 255, 255, 255};

// Gradient palette "bhw1_14_gp", originally from
// http://seaviewsensing.com/pub/cpt-city/bhw/bhw1/bhw1_14.c3g
const uint8_t semi_blue_gp[] = {0,  0,   0,   0,  12, 24,  4,   38, 53, 55, 8,   84, 80, 43, 48,  159, 119, 31,
...
const uint8_t pink_candy_gp[] = {0,   255, 255, 255, 45, 50,  64,  255, 112, 242, 16,  186, 140, 255,
...
const uint8_t red_reaf_gp[] = {0, 36, 68, 114, 104, 149, 195, 248, 188, 255, 0, 0, 255, 94, 14, 9};

// Gradient palette "bhw2_23_gp", originally from
// http://seaviewsensing.com/pub/cpt-city/bhw/bhw2/bhw2_23.c3g
const uint8_t aqua_flash_gp[] = {0,   0,   0,   0,   66,  130, 242, 245, 96,  255, 255, 53, 124, 255,
...
const uint8_t lite_light_gp[] = {0,  0,  0,  0,  9,   20, 21, 22, 40,  46, 43, 49,
...
const uint8_t red_flash_gp[] = {0, 0, 0, 0, 99, 242, 12, 8, 130, 253, 228, 163, 155, 242, 12, 8, 255, 0, 0, 0};

// Gradient palette "bhw3_40_gp", originally from
// http://seaviewsensing.com/pub/cpt-city/bhw/bhw3/bhw3_40.c3g
const uint8_t blink_red_gp[] = {0,   4,   7,   4,   43,  40,  25, 62,  76,  61,  15, 36,  109, 207, 39, 96,
...
const uint8_t red_shift_gp[] = {0,   98, 22,  93,  45, 103, 22,  73,  99, 192, 45,  56, 132, 235,
...
const uint8_t red_tide_gp[] = {0,   251, 46,  0,   28,  255, 139, 25,  43, 246, 158, 63,  58,  246, 216,
...
const uint8_t candy2_gp[] = {0,   109, 102, 102, 25,  42,  49,  71,  48,  121, 96,  84,  73,  241,
                             214, 26,  89,  216, 104, 44,  130, 42,  49,  71,  163, 255, 177, 47,
                             186, 241, 214, 26,  211, 109, 102, 102, 255, 20,  19,  13};

const byte trafficlight_gp[] = {0,   0,   0,   0,   // black
                                85,  0,   255, 0,   // green
                                170, 255, 255, 0,   // yellow
                                255, 255, 0,   0};  // red

const byte Aurora2_gp[] = {0,   17,  177, 13,    // Greenish
...
// Rainbow colors
const TProgmemRGBPalette16 RainbowColors_gc22 = {0xFF0000, 0xEB7000, 0xD59B00, 0xD5BA00, 0xD5D500, 0x9CEB00,
...
const TProgmemRGBPalette16 RainbowStripeColors_gc22 = {0xFF0000, 0x000000, 0xD59B00, 0x000000, 0xD5D500, 0x000000,
