...
class RF433Usermod : public Usermod {
 ...
 public:
  ...
  bool remoteJson433(int button) {
    ...
    while (strip.isUpdating() && millis() - start < RF433_BUSWAIT_TIMEOUT) {
...
const char RF433Usermod::_modName[]    = "RF433 Remote";
const char RF433Usermod::_modEnabled[] = "Enabled";
const char RF433Usermod::_receivePin[] = "RX Pin";
