...
class Si7021_MQTT_HA : public Usermod {
 private:
  ...
  void _publishHAMqttSensor(const String &name, const String &friendly_name, const String &state_topic,
  ...
  void _updateSensorData() {
    ...
    if (sendAdditionalSensors) {
      ...
      sensorAbsoluteHumidity =
          EnvironmentCalculations::AbsoluteHumidity(sensorTemperature, sensorHumidity, envTempUnit);
