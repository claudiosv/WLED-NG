...
#define FLD_ESP32_USE_THREADS  // comment out to use 0.13.x behaviour without parallel update task - slower, but more
                               // robust. May delay other tasks like LEDs or audioreactive!!
#endif
...
class FourLineDisplayUsermod : public Usermod {
 ...
 public:
  ...
  static FourLineDisplayUsermod *getInstance(void) {
    return instance;
  }
#endif
