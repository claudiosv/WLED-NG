...
class UsermodTemperature : public Usermod {
 private:
  ...
  static UsermodTemperature *_instance;  // to overcome nonstatic getTemperatureC() method and avoid
                                         // UsermodManager::lookup(USERMOD_ID_TEMPERATURE);

 public:
  UsermodTemperature() {
    _instance = this;
  }
  static UsermodTemperature *getInstance() {
    return UsermodTemperature::_instance;
  }
