# WLED - ESP32 LED Controller Firmware

WLED is a fast and feature-rich implementation of an ESP32 webserver to control NeoPixel (WS2812B, WS2811, SK6812) LEDs and SPI-based chipsets. The project consists of C++ firmware for microcontrollers and a modern web interface.
...
- Common firmware environments: `esp32dev`, `esp32c3dev`, `esp32s3dev_8MB_opi`
